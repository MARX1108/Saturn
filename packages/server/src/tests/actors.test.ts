...
describe('Actors Routes', () => {
  ...
  describe('GET /api/search/actors', () => {
    it('should search for actors by username', async () => {
      ...
      expect(
        response.body.some((u: any) => u.preferredUsername === 'testuser')
      ).toBeTruthy();
      expect(
        response.body.some((u: any) => u.preferredUsername === 'testuser1')
      ).toBeTruthy();
      expect(
        response.body.some((u: any) => u.preferredUsername === 'testuser2')
      ).toBeTruthy();
    });
